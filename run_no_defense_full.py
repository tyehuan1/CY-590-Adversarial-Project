"""
Full attack suite with NO DEFENSE - all combinations.
...
def main():
    print("="*70)
    print("FULL ATTACK SUITE - NO DEFENSE")
    ...
    # Create runner with NO defenses
    runner = AttackRunner(
    ...
    csv_filename = f"results/no_defense_full_{timestamp}.csv"
    json_filename = f"results/no_defense_metrics_{timestamp}.json"
